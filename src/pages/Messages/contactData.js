const contactData = {
    1 : {
        ...
        messages: [
            ...
            { id: 2, isYou: true, name: 'You', message: 'I can do it for $30', image_src: "/photos/PostMalone.jpeg"},
            { id: 3, isYou: false, name: 'Steve', message: 'Ok ill buy it for $30', image_src: '/photos/Gentlemen1.jpeg'},
            { id: 4, isYou: true, name: 'You', message: 'Perfect! Its yours!', image_src: "/photos/PostMalone.jpeg"},
        ]
    },
    2 : {
        id:2,
        ...
        messages: [
            ...
            { id: 2, isYou: true, name: 'You', message: 'Sure, where do you live', image_src: "/photos/PostMalone.jpeg"},
            { id: 3, isYou: false, name: 'Carlos', message: '123 Green street', image_src: '/photos/Gentlemen2.jpeg'},
            { id: 4, isYou: true, name: 'You', message: 'Ok, ill be there in 5 mins', image_src: "/photos/PostMalone.jpeg"},
        ]
    },
    3 : {
        id:3,
        ...
        messages: [
            ...
            { id: 2, isYou: true, name: 'You', message: 'Which one are you talking about', image_src: "/photos/PostMalone.jpeg"},
            { id: 3, isYou: false, name: 'Jenny', message: 'The Raincoat', image_src: '/photos/Ladie1.jpeg'},
            { id: 4, isYou: true, name: 'You', message: 'Sorry i sold that just 10 mins ago', image_src: "/photos/PostMalone.jpeg"},
        ]
    },
    4 : {
        id:4,
        ...
        messages: [
            ...
            { id: 2, isYou: true, name: 'You', message: 'How about $8', image_src: "/photos/PostMalone.jpeg"},
            { id: 3, isYou: false, name: 'Ruby', message: 'Nope $9', image_src: '/photos/Ladie2.jpeg'},
            { id: 4, isYou: true, name: 'You', message: 'Alright Ill take it', image_src: "/photos/PostMalone.jpeg"},
        ]
    }
}
